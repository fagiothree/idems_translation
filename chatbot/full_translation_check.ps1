...
$LOG13 = "13 - Log of errors in file found using overall_integrity_check"
$LOG14 = "C:/Users/edmun/Google Drive - EEM Engineering Ltd/Translation Checking/SA 13.12.21/14 - Excel Acceptance Log.xlsx"
...
Node index overall_integrity_check $JSON11Path $OutputDir $LOG13 $LOG14
