$InputFile = "C:/Users/edmun/Google Drive - EEM Engineering Ltd/Translation Checking/Malay 30.11.21/7 - PLH with MSA.json"
$OutputDir = "C:/Users/edmun/Google Drive - EEM Engineering Ltd/Translation Checking/Malay 30.11.21"
